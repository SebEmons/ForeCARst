...
Since Leon had chosen the Web Developer Track, he focused on the development of the website and built the website. For the website code we often used Bootstrap to make things easier and because of the more modern design of the buttons etc. In addition we used Bootstrap’s Grid-System to divide each site into different parts and to improve the visibility of the website.
...
By now you can start the website via the Python code. The data is saved locally on the used device, because we aren’t working with a server yet.
### Result
Let’s give you a brief insight in our website for foreCARst:
